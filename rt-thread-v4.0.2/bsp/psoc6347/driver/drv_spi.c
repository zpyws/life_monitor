...
static const struct cy8c63_spi_config spi_config[] =
{
#ifdef BSP_USING_SPI1
    SPI1_BUS_CONFIG,
#endif
...
static struct cy8c63_spi spi_bus_obj[sizeof(spi_config) / sizeof(spi_config[0])] = {0};

static rt_err_t cy8c63_spi_init(struct cy8c63_spi *spi_drv, struct rt_spi_configuration *cfg)
{
                              ...
                              struct rt_spi_configuration *configuration)
{
    ...
    return cy8c63_spi_init(spi_drv, configuration);
}

static const struct rt_spi_ops cy8c63_spi_ops =
{
...
static int rt_hw_spi_bus_init(void)
{
    ...
    for (int i = 0; i < sizeof(spi_config) / sizeof(spi_config[0]); i++)
    {
        ...
        result = rt_spi_bus_register(&spi_bus_obj[i].spi_bus, spi_config[i].bus_name, &cy8c63_spi_ops);
...
static void cy8c63_get_dma_info(void)
{
