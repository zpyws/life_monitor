...
static inline int power_supply_is_amp_property(enum power_supply_property psp)
{
	switch (psp) {
...
static inline int power_supply_is_watt_property(enum power_supply_property psp)
{
	switch (psp) {
